  ...
  describe UdpWriteSocket do
    ...
    describe "initialize" do
      it "creates a socket" do
        ...
        udp.close
        # UDP multicast does not work in Jruby and multicast connect/bind
        # behaves differently on macOS (EADDRNOTAVAIL)
        if RUBY_ENGINE == 'ruby' and RbConfig::CONFIG['target_os'] !~ /darwin/
